...
account1.account.to_csv('../../accounts_data/hedge_account_' + cd_short_ma + '_' + cd_long_ma + '_' + cd_std + '.csv')
account1.trade_records.to_csv('../../accounts_data/hedge_records_' + cd_short_ma + '_' + cd_long_ma + '_' + cd_std + '.csv')
